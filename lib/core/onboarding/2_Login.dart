...
class _LoginPage extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    this.loginHint =
        getIt<PreferencesService>().instanceSettings.instance.loginHint;
  ...
  void oauthLogin(context) async {
    OauthService oa =
        await OauthService.setup(getIt<PreferencesService>().instanceSettings);
    setState(() {
      _spinner = "Waiting for user login";
    });
    await oa.authorize();
    setState(() {
      _spinner = "Login Successful";
    });
